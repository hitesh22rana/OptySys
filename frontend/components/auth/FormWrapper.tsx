...
export default function Form({
  ...
  return (
    <form
      onSubmit={onSubmit}
      className="relative flex flex-col justify-between h-full sm:gap-10 gap-8 sm:p-5 p-3 border-2 border-gray-200 shadow rounded-md max-w-md m-auto w-full bg-gradient-to-tl"
    >
