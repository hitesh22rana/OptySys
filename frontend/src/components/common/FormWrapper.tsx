...
export default function FormWrapper({
  ...
  return (
    <form
      onSubmit={onSubmit}
      className={`relative flex flex-col justify-between sm:gap-10 gap-8 sm:p-5 p-3 border-2 border-gray-200 bg-white shadow-lg drop-shadow-sm rounded-md max-w-md m-auto w-full h-auto ${className}`}
    >
